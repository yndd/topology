...
func (in *FabricTemplate) DeepCopyInto(out *FabricTemplate) {
	*out = *in
	if in.Tier1 != nil {
		...
		*out = new(FabricTemplateTier)
		(*in).DeepCopyInto(*out)
	}
	if in.Pods != nil {
		in, out := &in.Pods, &out.Pods
		*out = make([]*FabricTemplatePod, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(FabricTemplatePod)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricTemplatePod) DeepCopyInto(out *FabricTemplatePod) {
	*out = *in
	if in.Tiers != nil {
		in, out := &in.Tiers, &out.Tiers
		*out = make(map[string]*FabricTemplateTier, len(*in))
		for key, val := range *in {
			var outVal *FabricTemplateTier
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FabricTemplatePod.
func (in *FabricTemplatePod) DeepCopy() *FabricTemplatePod {
	if in == nil {
		return nil
	}
	out := new(FabricTemplatePod)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FabricTemplateTier) DeepCopyInto(out *FabricTemplateTier) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FabricTemplateTier.
func (in *FabricTemplateTier) DeepCopy() *FabricTemplateTier {
	if in == nil {
		return nil
	}
	out := new(FabricTemplateTier)
